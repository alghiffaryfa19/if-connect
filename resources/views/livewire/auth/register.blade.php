<div class="flex">
    ...
    <div class="w-3/12 justify-end h-screen bg-gray-300 border-yellow-800 px-6  ">
        <form class="rounded mt-16 py-6 w-full text-yellow-900" wire:submit.prevent="register">
            ...
            <div class="mt-4 w-12/12 mb-6">
                <div class="mb-4 w-full ">
                    <label class="block text-yellow-900 text-sm font-bold mb-2 w-full" for="username">
                      NIM
                    </label>
                ...
                <div class="mb-4 w-full ">
                    <label class="block text-yellow-900 text-sm font-bold mb-2 w-full" for="name">
                      Name
                    </label>
                ...
                <div class="mb-4">
                    <label class="block text-yellow-900 text-sm font-bold mb-2" for="passwordConfirmation">
            ...
            <div class="fmt-6 flex flex-col text-sm">
                <a href="{{route('login')}}">Have account yet?</a>
            </div>
